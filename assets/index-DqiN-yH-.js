import{r as l,x as s}from"./index-B5RjiNqJ.js";import{B as S}from"./index-CrNmdQio.js";import{l as m,d,S as y,b as p,c as f,w as u,G as h,H as g,z as H}from"./index-DoCnFQRe.js";import{A as E}from"./index-CcJxjIlm.js";import{E as w}from"./index-CLZx2x_z.js";import{S as b,c as O}from"./Subject-C94a1-Sf.js";import{r as R,D as _}from"./array-Dgrncxgr.js";const k="cl:storage:sbwd:history",G="cl:storage:elsfk:history",C="cl:storage:sl:history";var n=(t=>(t.RELOAD_HISTORY="reload_history",t))(n||{});const x=new b;function A(t){x.next(t),m.event("history-action",t)}const j=O(x),$=d(y)`
  padding: 1rem;
`,z=d(p)`
  font-size: 1.8rem;
