import{r as n,o as t,p as N,u as v}from"./index-eNrvVRwa.js";import{d,u as z,a as u,o as L,i as M,b as F,p as c,T as g,q as R,r as B,s as W,t as _,S as k,B as A,A as O,l as U,c as H}from"./index-BSC-T3BG.js";import{B as C,u as E}from"./store-56jYH6-R.js";import{S as $,b as Y,g as G}from"./index-BkgQQtAE.js";function q(o,e){const r=new Date(o),s={yyyy:r.getFullYear(),yy:r.getFullYear()%100,MM:r.getMonth()+1,DD:r.getDate(),hh:r.getHours(),mm:r.getMinutes(),ss:r.getSeconds(),SS:r.getMilliseconds()};return e.replace(/[YyMDhmsS]+/g,l=>{var a;return((a=s[l])==null?void 0:a.toString().padStart(2,"0"))||l})}const V=n.memo(o=>{const{date:e,children:r,format:s="yyyy-MM-DD",className:l}=o,a=e||r;if(!a)return null;const i=q(a,s);return t.jsx("span",{className:l,children:i})}),D=d(u)`
  overflow: hidden;
`,J=d.section`
  display: grid;
  width: 100%;
