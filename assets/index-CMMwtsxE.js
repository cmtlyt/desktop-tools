import{r as l,x as s}from"./index-C38agaJn.js";import{B as S}from"./index-DQKqja4q.js";import{l as m,d,S as y,b as p,c as f,w as u,G as h,H as g,z as H}from"./index-DmYpbGJ8.js";import{A as E}from"./index-DDxRBp7K.js";import{E as w}from"./index-C9pdDsyR.js";import{S as b,c as O}from"./Subject-VZzc3fx1.js";import{r as R,D as _}from"./array-CM9hxbJX.js";const k="cl:storage:sbwd:history",G="cl:storage:elsfk:history",C="cl:storage:sl:history";var n=(t=>(t.RELOAD_HISTORY="reload_history",t))(n||{});const x=new b;function A(t){x.next(t),m.event("history-action",t)}const j=O(x),$=d(y)`
  padding: 1rem;
`,z=d(p)`
  font-size: 1.8rem;
