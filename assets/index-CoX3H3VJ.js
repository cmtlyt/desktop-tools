import{r as l,x as s}from"./index-BUm1efIT.js";import{B as S}from"./index-C1796vyK.js";import{l as m,d,S as y,b as p,c as f,w as u,E as h,G as g,z as E}from"./index-C3E55VMa.js";import{A as H}from"./index-CYrVEgpT.js";import{E as w}from"./index-Dao0OglI.js";import{S as b,c as O}from"./Subject-BuatV6Iq.js";import{r as R,D as _}from"./array-BbWYwR3J.js";const k="cl:storage:sbwd:history",G="cl:storage:elsfk:history",C="cl:storage:sl:history";var n=(t=>(t.RELOAD_HISTORY="reload_history",t))(n||{});const x=new b;function A(t){x.next(t),m.event("history-action",t)}const j=O(x),$=d(y)`
  padding: 1rem;
`,z=d(p)`
  font-size: 1.8rem;
