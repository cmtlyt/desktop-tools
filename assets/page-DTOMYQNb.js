import{r as s,y as t,z as L}from"./index-CfwBVzOL.js";import{d as c,e as R,b as m,q as b,k as z,a as F,r as a,T as p,s as B,t as y,v as W,w as k,S as _,B as A,x as M,A as U,l as O,c as H,y as G,j as Y}from"./index-CnrgWnd9.js";import{u as $}from"./store-Cwvo1eqR.js";import{D as q,E as V}from"./index-Dlw-UWBC.js";import{B as T}from"./index-BSUe0tgs.js";import{S as E}from"./index-D9GgxVnM.js";import{u as J}from"./use-navigate-0cTYKZim.js";import"./index-2Fq0qy_u.js";import"./asyncToGenerator-CFFvzZYl.js";import"./index-DqussmJY.js";const C=c(m)`
  overflow: hidden;
`,K=c.section`
  display: grid;
  width: 100%;
...
`,X=s.memo(function(e){const{value:r,fontSize:n=20,decimalSize:d=16,symbolSize:l=14,color:i,decimalColor:x,symbolColor:w,showPrefix:h=!1,className:u}=e,[f,g]=String(r).split("."),[,N]=s.useState(),[D,I,P]=b([l,n,d]);return z(f)?null:t.jsxs(m,{className:u,$alignItems:F.BASELINE,onClick:v=>{v.stopPropagation(),N(Math.random())},children:[t.jsx(E,{if:h,children:()=>t.jsx(S,{$fontSize:D,$color:w||i,children:"¥"})}),t.jsx(S,{$fontSize:I,$color:i,children:f}),t.jsx(E,{if:(g==null?void 0:g.length)>0,children:()=>t.jsx(S,{$fontSize:P,$color:x||i,children:`.${g}`})})]})}),j=c(k)`
  margin-right: 1rem;
`,Z=s.memo(({children:o})=>{const e={[a.PAID]:{$presetTheme:p.SUCCESS},[a.UNPAID]:{$presetTheme:p.PROCESSING},[a.REFUNDED]:{$presetTheme:p.WARNING},[a.CANCELED]:{$presetTheme:p.INFO},[a.INCOME]:{$presetTheme:p.SUCCESS}}[o],r=B[o];return t.jsx(j,{...e,children:r})}),ee=s.memo(({children:o})=>{const e=y[o];return t.jsx(j,{children:e})}),te=s.memo(({children:o})=>{const e=W[o];return t.jsx(j,{children:e})}),oe=c(q)`
  display: flex;
  align-items: center;
  margin-left: 1rem;
`,re=c.span`
...
`;function me(o){const{deleteFlow:e}=Y();e(o)}function Ee(){const o=L(),{setFlow:e}=$("setFlow"),{flows:r}=M("flows"),{flows:n}=o,d=J(),l=s.useMemo(()=>n||r,[r,n]);return s.useEffect(()=>{e(void 0)},[e]),t.jsx(U,{onFirstAppear:()=>O.appear("flow-list"),children:t.jsx(de,{$direction:H.COLUMN,children:t.jsx(G,{if:l.length>0,fullback:t.jsx(V,{}),children:()=>l.map(i=>t.jsx(ce,{flow:i,onDelete:me,onClick:()=>{e(i),d(`/flow/detail/${i.id}`)}},i.id))})})})}async function Ce(){return window.logger.todo("请求接口加载流水信息, 报错时使用本地存储中的流水信息"),{flows:null}}function he(){return t.jsx(T,{buttons:[{text:"新建",to:"/flow/editor",$presetTheme:A.PRIMARY}]})}const $e={title:"流水列表",crumbLabel:"列表",rightArea:t.jsx(he,{})};export{Ee as Component,$e as handle,Ce as loader};
