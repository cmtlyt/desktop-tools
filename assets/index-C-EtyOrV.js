...
`,ft=p(U)`
  ...
  white-space: nowrap;
  overflow: hidden;
`;function pt(){var d,m,h,N;const e=Pe(),n=le(),t=v.useMemo(()=>n.at(-1),[n]),r=(d=t==null?void 0:t.handle)==null?void 0:d.title,a=(m=t==null?void 0:t.handle)==null?void 0:m.needBackIcon,o=(h=t==null?void 0:t.handle)==null?void 0:h.rightArea,l=(N=t==null?void 0:t.handle)==null?void 0:N.titleArea;return s.jsxs(ut,{$gap:"1",$justifyContent:Be.BETWEEN,children:[s.jsxs(ft,{$alignItems:ce.CENTER,children:[s.jsx(He,{when:a,children:()=>s.jsx(dt,{onClick:()=>{Z.click("header-back-icon"),e(-1)}})}),s.jsx(mt,{children:l||r})]}),s.jsx(U,{$alignItems:ce.CENTER,children:o})]})}function ht(e){return Ge({attr:{fill:"currentColor",viewBox:"0 0 16 16"},child:[{tag:"path",attr:{d:"M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m.646 2.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L4.293 8 2.646 6.354a.5.5 0 0 1 0-.708M7 6.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m0 3a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m-5 3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"},child:[]}]})(e)}const gt=p(Ue)`
  display: flex;
...
`;function tn(){return s.jsxs(Lt,{content:["cmtlyt","desktop-tools"],font:{color:"rgba(0,0,0,0.05)"},children:[s.jsx(Mt,{}),s.jsx(Te,{}),s.jsx(Ve,{}),s.jsxs(U,{$flex:"1",style:{height:"100%"},children:[s.jsx(jt,{}),s.jsxs(U,{$flex:"1",$direction:Q.COLUMN,style:{overflow:"hidden"},children:[s.jsx(pt,{}),s.jsx(Wt,{$flex:"1",$direction:Q.COLUMN,children:s.jsx(Fe,{})}),s.jsx(Ct,{})]})]})]})}export{tn as Component};
