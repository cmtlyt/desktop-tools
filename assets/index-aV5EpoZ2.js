import{r as l,x as s}from"./index-BGAh7qpc.js";import{B as S}from"./index-DXc5HYWZ.js";import{l as m,d,S as y,b as p,c as f,w as u,G as h,H as g,z as H}from"./index-CXd2CK8p.js";import{A as E}from"./index-DZXnG-F6.js";import{E as w}from"./index-EfgBKuQ3.js";import{S as b,c as O}from"./Subject-DgdmjSy7.js";import{r as R,D as _}from"./array-D4k_YaVf.js";const k="cl:storage:sbwd:history",G="cl:storage:elsfk:history",C="cl:storage:sl:history";var n=(t=>(t.RELOAD_HISTORY="reload_history",t))(n||{});const x=new b;function A(t){x.next(t),m.event("history-action",t)}const j=O(x),$=d(y)`
  padding: 1rem;
`,z=d(p)`
  font-size: 1.8rem;
