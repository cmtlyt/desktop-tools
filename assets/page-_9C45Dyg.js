const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-CpaMCGBY.js","assets/index-DJrG1xPe.js","assets/index-Dk2L6hWJ.css"])))=>i.map(i=>d[i]);
import{n as Y,r as p,j as e,aJ as j,G as z,m as I,H as O,aK as G,a4 as C,l as k,aL as V,a3 as U}from"./index-DJrG1xPe.js";import{R as B}from"./index-CY4CoSrh.js";import{d as g}from"./styled-components.browser.esm-DqKzGx4B.js";import{a as q,b as K}from"./index-BpMDVfrc.js";import{a as X,b as J}from"./index-BBQGFywX.js";import{b as w,d as Q}from"./button-PCnrASaF.js";import{I as Z}from"./index-DK7ZVEEE.js";import{D as L}from"./index-DTMKmHFD.js";import{S as D}from"./index-Baf81WNP.js";import{S as _}from"./index-B4g9YTQJ.js";import{S as H}from"./index-CrM76nJY.js";import{i as ee}from"./is-phone-Su64e2ba.js";import{u as te}from"./use-web-worker-C2j5SHPz.js";import"./index-FW-CBbkv.js";import"./index-DO56UWJv.js";import"./iconBase-BYZREarr.js";import"./index-B0Q1bNvC.js";import"./index-DhNZMwX7.js";import"./asyncToGenerator-DzqYdxh4.js";import"./reactNode-BdSFPvQq.js";import"./pickAttrs-BGPf_sI4.js";import"./compact-item-DkjX-R25.js";import"./fade-DQFTUg2F.js";import"./LoadingOutlined-CAdfLFNv.js";import"./useForceUpdate-DsIOcIgt.js";import"./PurePanel-CSBcRbQl.js";import"./UnstableContext-B_xzIoom.js";import"./useLocale-zE0jkxy2.js";import"./EyeOutlined-DsH6MJkM.js";import"./index-D82RUISd.js";import"./context-B56VWYPi.js";import"./Skeleton-CZmr1gIm.js";import"./useVariants-CG1IvSK5.js";import"./index-DjjJ3gxt.js";const{useStoreSlice:E,getStore:x}=Y((i,n)=>({images:[],showForm:!1,printMod:"snapdom",saveSize:{width:0,height:0,aspectRatio:1,scale:2},setImages:t=>i({images:t}),setShowForm:t=>i({showForm:t}),setPrintMod:t=>i({printMod:t}),setSaveSize:t=>i({saveSize:{...n().saveSize,...t}})})),ne=g.span`
  position: absolute;
  left: 0;
  right: 0;
  bottom: 0;
...
`,T=p.memo(i=>{const{idx:n,data:t={},disableRemove:s=!1,images:l,onChange:m,onEditOption:c=j,onRemove:r=j}=i;return e.jsxs(w,{$direction:"column",$gap:"0.5rem",children:[e.jsxs(de,{$alignItems:"center",$gap:"0.5rem",children:[e.jsx(H,{value:t.bg||"",options:l,onChange:d=>m(n,"bg",d)}),e.jsx(D,{when:!s,children:()=>e.jsx(J,{onClick:()=>r(n)})})]}),e.jsxs(le,{$gap:"0.5rem",children:[e.jsx("input",{type:"text",defaultValue:t.text||"",onChange:d=>m(n,"text",d.target.value)}),e.jsx(Q,{onClick:()=>c({...t,idx:n}),children:"配置"})]})]})});function ue(i,n,t){!t[n]||i[0][n]||i.forEach(s=>{s[n]||(s[n]=t[n])})}const P=g.label`
  display: flex;
  align-items: center;
  line-height: 1;
