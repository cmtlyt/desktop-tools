import{r as i,o as e,p as M,u as L}from"./index-Dj8bhynk.js";import{d as u,u as v,a as h,k as E,i as z,b as T,T as x,m as B,S as Y,B as F,A as U,l as W,c as G}from"./index-CT0jm8R7.js";import{a,A as c,F as n,B as N,u as j}from"./flow-CCI7PAWl.js";import"./use-selector-Dcq5A3cA.js";function H(r,t){const o=new Date(r),l={yyyy:o.getFullYear(),yy:o.getFullYear()%100,MM:o.getMonth()+1,DD:o.getDate(),hh:o.getHours(),mm:o.getMinutes(),ss:o.getSeconds(),SS:o.getMilliseconds()};return t.replace(/[YyMDhmsS]+/g,s=>{var d;return((d=l[s])==null?void 0:d.toString().padStart(2,"0"))||s})}const O=i.memo(r=>{const{date:t,children:o,format:l="yyyy-MM-DD",className:s}=r,d=t||o;if(!d)return null;const m=H(d,l);return e.jsx("span",{className:s,children:m})}),C=u(h)`
  overflow: hidden;
`,k=u.section`
  display: grid;
  width: 100%;
