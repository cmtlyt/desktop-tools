...
`,q=h.span`
  ...
  ${p.bind(null,"$style")}
`;function X(t){const{direction:e,needActiveStyle:r,shadowOption:n,className:a,appListHander:o=i=>i}=t,d=E(),l=g.useMemo(()=>d.at(-1),[d]),s=g.useCallback((i,S=!1)=>S?r&&d.some(v=>!!y((v==null?void 0:v.pathname)||"",i)):r&&!!y((l==null?void 0:l.pathname)||"",i),[r,l,d]),$=g.useMemo(()=>o(G),[o]);return c.jsx(j,{$wrap:M.wrap,$direction:e,className:a,children:$.map(i=>c.jsx(H,{to:i.path,$isActive:s(i.path,i.deepMatch),$style:i.wrapperStyle,onClick:()=>N.click("app-list-click",{app:i}),children:c.jsxs(J,{$direction:F.column,$alignItems:L.center,$justifyContent:z.between,$style:i.contentStyle,...n,children:[c.jsx(K,{$style:i.iconStyle,children:typeof i.icon=="string"?c.jsx("span",{children:i.icon}):i.icon}),c.jsx(q,{$style:i.labelStyle,children:i.name})]})},i.path))})}export{X as A,P as G,V as T};
