import{r as l,y as s}from"./index-CjNiMQur.js";import{B as S}from"./index-DtJMEvcR.js";import{l as d,d as m,S as y,b as p,A as f,c as u,x as h,G as g,I as E,C as H}from"./index-BjqInUx_.js";import{E as b}from"./index-CDGG00rn.js";import{S as w,c as O}from"./create-action-subscribe-hook-vChOzdXa.js";import{r as R,D as _}from"./array-DVeJD4Re.js";const F="cl:storage:sbwd:history",k="cl:storage:elsfk:history",C="cl:storage:sl:history";var n=(t=>(t.RELOAD_HISTORY="reload_history",t))(n||{});const x=new w;function A(t){x.next(t),d.event("history-action",t)}const j=O(x),G=m(y)`
  padding: 1rem;
`,$=m(p)`
  font-size: 1.8rem;
