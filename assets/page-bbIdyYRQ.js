...
`,be=C(q)`
  ...
  ${({$actived:e})=>e?`
    ...
    `:""}
`,Ce=j.memo(()=>{const{checkerboard:e}=E("checkerboard");return u.jsx(ue,{$direction:S.COLUMN,children:e.map((r,l)=>u.jsx(xe,{rowInfo:r,row:l},l))})}),xe=e=>{const{rowInfo:r,row:l}=e,{currentChessMovePoints:t}=E("currentChessMovePoints");return u.jsx(we,{children:r.map((a,n)=>u.jsx(ye,{info:a,row:l,cel:n,activePoints:t},n))})};function ke(e,r){const{isActive:l,type:t}=e,a=k(),{currentUser:n}=a;if(n!==e.color)return;const{checkerboard:i,currentChess:g,changeCheckerboard:f,setCurrentChessMovePoints:c,setCurrentChess:o}=a,[s,v]=r;f(d=>{if(g){const{pos:z}=g;d[z[0]][z[1]].isActive=!1}const h=d[s][v];h.isActive=!l});const p=l?void 0:ge(i,t,{...e,pos:r});c(p),o(l?void 0:{...e,pos:r})}function $e(e){const{currentChess:r,changeCheckerboard:l,setCurrentChess:t,setCurrentChessMovePoints:a,changeUser:n}=k();l(i=>{de(i,r,e)}),t(void 0),a(void 0),n()}function ye(e){const{info:r,row:l,cel:t,activePoints:a}=e,n=a==null?void 0:a.includes(`${l},${t}`),{isActive:i,...g}=r||{};return u.jsx(ze,{$actived:n,onClick:()=>n&&$e([l,t]),children:u.jsx(_,{if:r,fullback:u.jsx("section",{}),children:()=>u.jsx(be,{$actived:i,...g,onClick:()=>{n||ke(r,[l,t])}})})})}function Ae(){return u.jsx(W,{buttons:[{text:"后退",noLog:!0,onClick:le},{text:"前进",noLog:!0,onClick:re},{text:"保存局势",noLog:!0,onClick:te},{text:"恢复局势",noLog:!0,onClick:ae},{text:"重开",noLog:!0,onClick:k().restart}]})}function Ge(){const{currentUser:e}=E("currentUser");return ie(r=>{const{ext:l}=r,t=l==null?void 0:l.winColor;if(!t)return;const{showMessage:a}=M();a({content:`${t==="red"?"红":"黑"}方胜利`,type:"success"})},I.GAME_OVER),u.jsx(x,{$flex:"1",$direction:S.COLUMN,$alignItems:B.CENTER,$justifyContent:L.CENTER,children:u.jsx(fe,{style:{transform:`rotate(${e==="red"?0:180}deg)`},$flex:"1",$alignItems:B.CENTER,$justifyContent:L.CENTER,children:u.jsxs(pe,{$direction:S.COLUMN,children:[u.jsx(me,{}),u.jsx(Ce,{})]})})})}const Oe={title:"中国象棋-单人推演模式",needBackIcon:!0,rightArea:u.jsx(Ae,{})};export{Ge as Component,Oe as handle};
