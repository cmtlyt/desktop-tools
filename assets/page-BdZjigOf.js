import{r as s,x as t,y as L}from"./index-Da5SARoI.js";import{d as c,e as R,b as m,r as b,m as z,a as F,s as a,T as p,t as B,v as y,w as W,x as k,S as _,B as A,y as M,A as U,l as O,c as H,z as G,k as Y}from"./index-D_6Vb4y8.js";import{u as $}from"./store-PsTP62hJ.js";import{D as V,E as q}from"./index-3gj4c8_3.js";import{B as T}from"./index-NgrMwzGA.js";import{S as j}from"./index-DLUWWLMN.js";import{u as J}from"./use-navigate-xU1e5SYn.js";import"./index-BMz_B_2v.js";import"./genStyleUtils-C0DH2fsD.js";import"./index-BpRcQZ9o.js";const C=c(m)`
  overflow: hidden;
`,K=c.section`
  display: grid;
  width: 100%;
...
`,X=s.memo(function(e){const{value:r,fontSize:n=20,decimalSize:d=16,symbolSize:l=14,color:i,decimalColor:x,symbolColor:w,showPrefix:h=!1,className:u}=e,[f,g]=String(r).split("."),[,N]=s.useState(),[D,I,P]=b([l,n,d]);return z(f)?null:t.jsxs(m,{className:u,$alignItems:F.BASELINE,onClick:v=>{v.stopPropagation(),N(Math.random())},children:[t.jsx(j,{if:h,children:t.jsx(S,{$fontSize:D,$color:w||i,children:"¥"})}),t.jsx(S,{$fontSize:I,$color:i,children:f}),t.jsx(j,{if:(g==null?void 0:g.length)>0,children:t.jsx(S,{$fontSize:P,$color:x||i,children:`.${g}`})})]})}),E=c(k)`
  margin-right: 1rem;
`,Z=s.memo(({children:o})=>{const e={[a.PAID]:{$presetTheme:p.SUCCESS},[a.UNPAID]:{$presetTheme:p.PROCESSING},[a.REFUNDED]:{$presetTheme:p.WARNING},[a.CANCELED]:{$presetTheme:p.INFO},[a.INCOME]:{$presetTheme:p.SUCCESS}}[o],r=B[o];return t.jsx(E,{...e,children:r})}),ee=s.memo(({children:o})=>{const e=y[o];return t.jsx(E,{children:e})}),te=s.memo(({children:o})=>{const e=W[o];return t.jsx(E,{children:e})}),oe=c(V)`
  display: flex;
  align-items: center;
  margin-left: 1rem;
`,re=c.span`
...
`;function me(o){const{deleteFlow:e}=Y();e(o)}function je(){const o=L(),{setFlow:e}=$("setFlow"),{flows:r}=M("flows"),{flows:n}=o,d=J(),l=s.useMemo(()=>n||r,[r,n]);return s.useEffect(()=>{e(void 0)},[e]),t.jsx(U,{onFirstAppear:()=>O.appear("flow-list"),children:t.jsx(de,{$direction:H.COLUMN,children:t.jsx(G,{if:l.length>0,fullback:t.jsx(q,{}),children:l.map(i=>t.jsx(ce,{flow:i,onDelete:me,onClick:()=>{e(i),d(`/flow/detail/${i.id}`)}},i.id))})})})}async function Ce(){return window.logger.todo("请求接口加载流水信息, 报错时使用本地存储中的流水信息"),{flows:null}}function he(){return t.jsx(T,{buttons:[{text:"新建",to:"/flow/editor",$presetTheme:A.PRIMARY}]})}const $e={title:"流水列表",crumbLabel:"列表",rightArea:t.jsx(he,{})};export{je as Component,$e as handle,Ce as loader};
