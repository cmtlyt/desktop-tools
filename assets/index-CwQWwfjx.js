...
`,Q=m.span`
  ...
  ${p.bind(null,"$style")}
`;function Y(t){const{direction:e,needActiveStyle:r,shadowOption:n,className:a,appListHander:o=i=>i}=t,d=E(),s=g.useMemo(()=>d.at(-1),[d]),c=g.useCallback((i,S=!1)=>S?r&&d.some(v=>!!y((v==null?void 0:v.pathname)||"",i)):r&&!!y((s==null?void 0:s.pathname)||"",i),[r,s,d]),$=g.useMemo(()=>o(H),[o]);return l.jsx(w,{$wrap:M.wrap,$direction:e,className:a,children:$.map(i=>l.jsx(J,{to:i.path,$isActive:c(i.path,i.deepMatch),$style:i.wrapperStyle,onClick:()=>N.click("app-list-click",{app:i}),children:l.jsxs(K,{$direction:F.column,$alignItems:L.center,$justifyContent:k.between,$style:i.contentStyle,...n,children:[l.jsx(q,{$style:i.iconStyle,children:l.jsx(z,{if:typeof i.icon=="string",fullback:i.icon,children:l.jsx("span",{children:i.icon})})}),l.jsx(Q,{$style:i.labelStyle,children:i.name})]})},i.path))})}export{Y as A,P as G,X as T};
