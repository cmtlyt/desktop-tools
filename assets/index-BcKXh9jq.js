...
`,B=a.span`
  ...
  ${c.bind(null,"$style")}
`;function P(s){const{direction:o,needActiveStyle:r,shadowOption:z,className:f,appListHander:h=t=>t}=s,i=M(),n=m.useMemo(()=>i.at(-1),[i]),$=m.useCallback((t,y=!1)=>y?r&&i.some(l=>!!d((l==null?void 0:l.pathname)||"",t)):r&&!!d((n==null?void 0:n.pathname)||"",t),[r,n,i]),g=m.useMemo(()=>h(k),[h]);return e.jsx(v,{$wrap:j.WRAP,$direction:o,className:f,children:g.map(t=>e.jsx(F,{to:t.path,$isActive:$(t.path,t.deepMatch),$style:t.wrapperStyle,onClick:()=>b.click("app-list-click",t),children:e.jsxs(V,{$direction:A.COLUMN,$alignItems:p.CENTER,$justifyContent:u.BETWEEN,$style:t.contentStyle,...z,children:[e.jsx(N,{$style:t.iconStyle,$alignItems:p.CENTER,$justifyContent:u.CENTER,children:e.jsx(w,{if:typeof t.icon=="string",fullback:t.icon,children:e.jsx("span",{children:t.icon})})}),e.jsx(B,{$style:t.labelStyle,children:t.name})]})},t.path))})}export{P as A,O as G};
